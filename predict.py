...
if __name__ == '__main__': 
    ...
    # Load the YOLO model
    train_path = this_dir / "runs" / "train"
    train_folders = [f for f in os.listdir(train_path) if os.path.isdir(train_path / f) and f.startswith("yolo11n")]
    ...
    model_path = train_path / train_folders[idx] / "weights" / "best.pt"
